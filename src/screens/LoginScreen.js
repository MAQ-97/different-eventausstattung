    ...
    <>
      ...
      <View
        ...
        <TextInput
          ...
          right={
            <TextInput.Icon
              name={() => <Icon name={'eye-slash'} size={15} color="#9e8035" style={{}} />}
            />
          }
        />
        <TouchableOpacity>
        ...
        <Text style={{alignSelf: 'center', color: '#505050', textAlign: 'center'}}>
          Device: OnePlus A5010{'\n'}Android-Version: 10 (Api 29){'\n'}App-Version: 1.1 (3){'\n'}Device-ID: asdewrv-e345r-3f45-4534-435456563c34
        </Text>
        </ScrollView>
      </View>
    </>
